export const pl_synth_init = (ctx: AudioContext) => {
	...
	generate = (
		row_len: number, note: number, buf_l: Float32Array<ArrayBuffer> | number[], buf_r: Float32Array<ArrayBuffer> | number[], write_pos = 0,
	...
	apply_delay = (left: number[] | Float32Array<ArrayBuffer>, right: Float32Array<ArrayBuffer>, start: number, row_len: number, instrument: number[]) => {
	...
	sound = (instrument: number[], note = 147 /* C-5 */, row_len = 5513 /* 120 BPM */) => {
